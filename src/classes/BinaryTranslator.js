        ...
        while (!reader.reachedEnd()) {
            ...
            switch (opcode) {
                ...
                case 0x08: {
                    ...
                    if (participantId === this.participantId && this.recentSentNotes.get(time) === count) {
                        //ignore notes we've sent
        ...
        for (let messageObj of message) {
            switch (messageObj.m) {
                ...
                case 'n': {
                    ...
                    for (let otherTime of this.recentSentNotes.keys()) {
                        //filter out old recentSentNotes logs in case it didn't go through for whatever reason, to prevent memory buildup
